...
<head>
    ...
    <title>AI Chat Assistant - 710 Den Glass</title>
    ...
    <div class="container mt-4">
        <div class="chat-container">
            <div class="chat-actions">
                <button class="btn chat-action-btn" onclick="sendQuickMessage('Tell me about your featured products')">
                    Featured Products
                </button>
                <button class="btn chat-action-btn" onclick="sendQuickMessage('How do I care for my glass pieces?')">
                    Glass Care Tips
                </button>
                <button class="btn chat-action-btn" onclick="sendQuickMessage('What payment methods do you accept?')">
                    Payment Info
                </button>
                <button class="btn chat-action-btn" onclick="sendQuickMessage('Tell me about your shipping policy')">
                    Shipping Info
                </button>
            ...
            <div class="chat-wrapper">
                <div class="chat-header">
                    ...
                    <p>Ask me anything about 710 Den Glass products, glass care, or general questions!</p>
                </div>
                ...
                <div class="chat-messages" id="chatMessages">
                    <div class="message assistant">
                        ...
                        <div class="message-content">
                            Hello! I'm your AI assistant for 710 Den Glass. I'm here to help you with information about our premium glass collection, product care, shipping, and any other questions you might have. How can I assist you today?
                        </div>
                    </div>
                </div>
