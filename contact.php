...
<head>
    ...
    <title>Contact Us - 710 Den Glass</title>
    ...
    <nav class="navbar">
        <div class="container d-flex justify-content-center align-items-center">
            ...
            <ul class="navbar-nav me-auto">
                ...
                <form class="d-flex search-form me-2" action="shop.php" method="get">
                ...
                <div class="nav-btns">
                    ...
                    <a href="account.php" class="btn btn-icon">
                    ...
                    <form method="post" action="contact.php">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="subject" name="subject" required>
                                ...
                                <option value="Return Request" <?php echo (isset($subject) && $subject == 'Return Request') ? 'selected' : ''; ?>>Return Request</option>
